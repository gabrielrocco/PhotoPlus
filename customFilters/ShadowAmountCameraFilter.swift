...
class shadowAmountFilter: CIFilter
{
    let shadowAmountFilterKernel: CIColorKernel =
    {
...
//shadows
        shaderString += "if (hsv.z < 0.055 && hsv.y < 0.2){hue = 0.65; "
        shaderString += "sat = 1;"
    ...
    override var outputImage: CIImage?
    {
        ...
        return shadowAmountFilterKernel.apply(extent: inputImage.extent,
